...
from PyQt5.QtWidgets import (QApplication, QWidget, QAbstractItemView,
                             QListWidget, QPushButton, QLabel, QGridLayout)
...
class MyApp(QWidget):
    ...
    def initUI(self):
        ...
        self.LWTestItem = CreateGUI.CreateLWTestItem(self)



        ## Tire Design Paramter 선택
        self.LWTireSpecMainPart = CreateGUI.CreateLWTireSpecMainPart(self)
        ...
        layout.addWidget(self.LWTestItem, 0, 0)
        layout.addWidget(self.LWTireSpecMainPart, 1, 0)
    ...
    def clickedLTI(self, qmodelindex) :
        self.DB = []
        item = self.LWTestItem.currentItem()
    ...
    def clickedLTS(self, qmodelindex) :
        item = self.LWTireSpecMainPart.currentItem()
